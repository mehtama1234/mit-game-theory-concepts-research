...
CONCEPTS: list[dict[str, Any]] = [
    ...
    {"id": "imperfect_competition", "name": "Imperfect Competition", "theme": "mechanisms_and_markets", "lectures": [6, 11], "primitives": ["payoff_mapping", "best_response"], "keywords": ["imperfect competition", "market power", "Cournot", "Bertrand", "markup", "best response", "quantity", "price competition"], "definition": "A market setting where a firm's own price or quantity choice can move its payoff because rivals and buyers react."},
    ...
    {"id": "screening_and_adverse_selection", "name": "Screening And Adverse Selection", "theme": "private_information", "lectures": [23, 16], "primitives": ["belief", "incentive_compatibility"], "keywords": ["screening", "adverse selection", "market breakdown", "private information", "high costs", "gains from trade", "type", "incomplete information"], "definition": "A hidden-information problem where a rule or price changes who chooses to participate, sometimes making trade collapse."},
...
SUBTHEMES = [
    ...
    {"id": "hidden_types", "parent_theme": "private_information", "name": "Hidden Types And Beliefs", "concepts": ["bayesian_games", "types_and_beliefs", "bayesian_nash_equilibrium", "perfect_bayesian_equilibrium", "screening_and_adverse_selection"]},
    {"id": "rules_for_bidding", "parent_theme": "mechanisms_and_markets", "name": "Rules For Bidding", "concepts": ["imperfect_competition", "auctions", "revenue_equivalence", "ad_auctions"]},
